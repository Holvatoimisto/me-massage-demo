...
export interface LocationData {
  ...
  image: string;
  /**
   * Only the general ME massage online booking URL exists in the project
   * today; no location-specific booking destination has been verified.
   * Replace with a location-specific URL when one is available.
   */
  bookingUrl: string;
